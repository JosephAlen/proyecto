    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title"> <h1>Anadir Compra</h1> </div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index-2.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                    <li><i class=""></i>&nbsp;<a class="parent-item" href="index-2.html">Compras</a>&nbsp;<i class="fa fa-angle-right"></i>
                    <li class="active">Anadir Compra</li>
                </ol>
            </div>
        </div>

        <form action="{{route('purchase.store')}}" method="post" id="form_sample_1" class="form-horizontal" >
        <div class="row">
						...
						<div class="form-group">
                            <div class="form-body">
                            	<div class="col-sm-12 row" style="justify-content: center;">
						            <label class="col-sm-9" for="namem">Nombre del Proveedor
						                <span class="required"> * </span>
						            </label>
						            <div class="col-sm-9" >
						                <select class="form-control" id="id_proveedor" name="id_proveedor" data-live-search="true">
						                    <option value="0" disabled>Selecciona un Opcion</option>
						                    @foreach($providers as $prove)
						        ...
						        <br>
							    <div class="col-sm-12 row"style="justify-content: center;">
							        <label class="col-md-9">Número Compra
							            <span class="required"> * </span>
							        </label>
							        <div class="col-md-9">
							            <input type="text" name="num_compra" id="num_compra" class="form-control" placeholder="Introduzca el modelo..."> 
							        </div>
							    </div>  
						        <br>
							    <div class="col-sm-12 row"style="justify-content: center;">
						            ...
						            <div class="col-sm-9">
						                <select class="form-control" id="id_producto" name="id_producto" data-live-search="true">
						                    <option value="0" disabled>Selecciona un Opcion</option>
						                    @foreach($products as $prod)
				                            <option value="{{$prod->id}}">{{$prod->psucto}}</option> 
				                            @endforeach
						                </select>
						            </div>
						        </div> 
						        ...
						        <br>
							    <div class="col-sm-12 row"style="justify-content: center;">
							        <label class="col-md-9">Precio de Compra
							            <span class="required"> * </span>
							        </label>
							        <div class="col-md-9">
							...
							<div class="col-sm-12 row">
							    <div class="offset-md-3" >
							        <button type="button" id="agregar" class="btn btn-default btn-lg mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-success">
